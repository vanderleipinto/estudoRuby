...
# Esportista
# metodo competir -> imprime a mensagem "Participando de uma competição"

# JogadorDeFutebol
# metodo correr -> Imprime a mensagem: "Correndo atrás da bola"

# Maratonista
# metodo correr -> imprime a mensagem: "Percorrendo o circuito"

# As classes JogadorDeFutebol e Maratonista devem herdar os comportamentos da classe Esportista
# No final do programa execute os métodos competir e correrem objetos do tipo JogadorDeFutebol e Maratonista
...
rafael_veiga = JogadorDeFutebol.new
keniano = Maratonista.new

rafael_veiga.competir
rafael_veiga.correr
